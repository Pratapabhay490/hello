  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(135deg, #1E40AF, #1E3A8A)',
        'hero-gradient': 'linear-gradient(to bottom, transparent, rgba(0,0,0,0.9))',
      },
      boxShadow: {
        'glow': '0 0 20px rgba(59, 130, 246, 0.5)',
        'glow-lg': '0 0 30px rgba(59, 130, 246, 0.7)',
        'card': '0 4px 6px -1px rgba(0, 0, 0, 0.3)',
        'card-hover': '0 20px 25px -5px rgba(0, 0, 0, 0.6)',
      },
      animation: {
